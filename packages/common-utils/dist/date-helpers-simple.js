...
exports.isValidDate = exports.toISODateString = exports.getRecentMonthsRange = exports.getCurrentMonthRange = exports.manipulateDate = exports.isDateInRange = exports.calculateDateDifference = exports.formatRelativeTime = exports.formatKoreanDate = exports.formatDate = void 0;
/**
...
const formatRelativeTime = (date) => {
    ...
    if (diffInMs > 0) {
        ...
        if (absDiffInMinutes < 60)
            return `${absDiffInMinutes}분 후`;
        if (absDiffInHours < 24)
            return `${absDiffInHours}시간 후`;
        if (absDiffInDays < 30)
            return `${absDiffInDays}일 후`;
        if (absDiffInMonths < 12)
            return `${absDiffInMonths}개월 후`;
...
//# sourceMappingURL=date-helpers-simple.js.map